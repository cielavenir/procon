char *PROG=".eak.-.o.s.s.pxem";
char *CONTENT=
	".i.cL.x" //x while x>L (x>=M)
		".cR.x" //while x>R (x>=S)
			".cS.x" //while x>S (x>=T)
				".cV.x" //while x>V (x>=W)
					"3.o.d.a" //print 3 return
				".i.ch.x" //x while x>h
					"4.o.d.a" //print 4 return
				"2.o.d.a" //print 2 return
			"0.o.d.a" //print 0 return
		"5.o.d.a" //print 5 return
	"1.o.d.a"; //print 1 return
...
int main(){Pxem(PROG,CONTENT).run();}