...
import sys,time,random,hmac,hashlib,json
...
oauth={
	...
	'oauth_nonce': str(random.getrandbits(64)), #random
	'oauth_version': '1.0',
}
...
for k,v in params.items(): 
	if sys.version_info[0]>=3 or isinstance(v, unicode): params[k] = v.encode('utf8')
	oauth[k]=params[k]
