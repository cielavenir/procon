...
int main(){
	...
	string sorted=accumulate(a.begin(),a.end(),string(),[](string x,string y){return x+" "+y;}).substr(1);
	cout<<sorted<<endl;
	cout<<"Stable"<<endl;
	a=v;
	for(i=0;i<n;i++){
	...
	string sorted2=accumulate(a.begin(),a.end(),string(),[](string x,string y){return x+" "+y;}).substr(1);
	cout<<sorted2<<endl;
